...
export async function fetchBzProperties(market) {
  ...
  // Filter to only properties in this market's state.
  // bzIdentity doesn't match the company_id field on property objects —
  // those use a different internal ID range (e.g. 31305). State code is reliable.
