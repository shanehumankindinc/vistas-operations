...
function renderDownloadButton(vendor, periodStart) {
  ...
  return `
    <div class="no-print" style="text-align:right;padding:12px 28px 0;max-width:680px;margin:0 auto;">
      <button onclick="(function(){var t=document.title;document.title='${filename}';window.print();setTimeout(function(){document.title=t;},1000);})()" style="padding:7px 16px;background:#0f172a;color:#fff;border:none;border-radius:6px;font-size:13px;font-weight:600;cursor:pointer;font-family:inherit;">
        &#x2B73; Download PDF
      </button>
    </div>`;
}
